...
AxionAntiAFKConfig.AfkWarningTime = 300 -- 5 minute default (1 minute = 60)

-- Time (in seconds) before the player is kicked for being AFK
AxionAntiAFKConfig.AfkKickTime = 450 -- 7.5 minute default (1 minute = 60)
...
AxionAntiAFKConfig.MessageType = "axionnotification"
